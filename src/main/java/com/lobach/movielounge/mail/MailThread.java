...
public class MailThread extends Thread {
    ...
    public MailThread(String eventDateString, String eMail) {
    ...
    private void init() {
        ...
        try {
            ...
            String registrationMessage =  PropertyManager.getProperty("mail", REGISTRATION_MESSAGE);
            message.setContent(String.format(registrationMessage, eventDateString), TEXT_HTML_TYPE);
