                                ...
                                <form id="createEventAct" action="control_servlet" method="POST">
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        <div class="time_border">
                                            <input name="hours" type="number" class="time_item"
                                                   min="0" max="23" placeholder="12">:
                                            <input name="minutes" type="number" class="time_item"
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        <input name="movie1" type="text" class="form-control"
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        <input name="movie2" type="text" class="form-control"
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        <input name="movie3" type="text" class="form-control"
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="float-right button_yellow button_font-middle">
                                            <span class="button_title"><fmt:message key="create.event.button.create"/></span>
                                        </button>
                                    </div>
                                    <script>
                                        $('#date').datetimepicker({
